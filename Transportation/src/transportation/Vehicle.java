...
public class Vehicle {
	...
	public void run(int hours) {
		if (this.gasRemained <= 0) {
			...
			int gasConsumed = this.gasConsumedPerHour * hours;
			int tempGasRemained = this.gasRemained - gasConsumed;	
			
			if (tempGasRemained <=0) {
				System.out.println("Oops, gas out! Please add fuel!");
				this.totalGasConsumed += this.gasRemained;
				this.gasRemained = 0;
			} else {
				this.gasRemained = tempGasRemained;
	...
	public boolean equals(Object o) {
		...
		//cast given object to a Vehicle
		Vehicle otherVehicle = (Vehicle) o;
		
		//compare the two dogs based on their name and breed
		return (this.type.equals(otherVehicle.type) && this.brand.equals(otherVehicle.brand));
